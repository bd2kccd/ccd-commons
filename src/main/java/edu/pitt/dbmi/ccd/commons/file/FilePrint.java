...
public class FilePrint {
    ...
    public static String fileTimestamp(long timestamp) {
        return TIME_FORMATTER.format(ZonedDateTime.ofInstant(Instant.ofEpochMilli(timestamp), ZoneId.systemDefault()));
    }
